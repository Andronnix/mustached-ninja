...
function drawMenu(){
  ...
  for(var i = 0; i < this.menu.length; i++){
    var fn = function(o){ gMap.load(o); };       
    var btn = new fadeBtn(WIDTH/2.5, this.currY, WIDTH/4, 50, fn, this.menu[i], true, this.menuMaps[i]);
    this.currY += 70;
  }
